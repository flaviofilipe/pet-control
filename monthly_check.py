#!/usr/bin/env python3
"""
Script de conveniência para executar o relatório mensal de tratamentos

Este script é um wrapper para app/tasks/monthly_check.py
...
def main():
    ...
    script_path = Path(__file__).parent / "app" / "tasks" / "monthly_check.py"
